      ...
      <article className="br3 ba b--black-10 mv4 w-100 w-50-m w-25-l mw6 shadow-5 center">
        <main className="pa4 black-80">
          <div className="measure">
            ...
            <legend style={{ fontSize: '2rem', fontWeight: '600', color: 'white' }}>Register</legend>
              <div className="mt3">
              <label style={{ color: 'white' }} className="db fw6 lh-copy f6" htmlFor="name">Name</label>
                <input
                  ...
                  style={{ borderColor: 'white', boxShadow: '0 0 8px white, 0 0 16px white' }}
                />
              </div>
              <div className="mt3">
